const visaRequirementsData = {
	...
	Philippines: {
        ...
        notice:[ "Nationals from the following countries have to wait five (5) working days before the release of their visas: Algeria, Azerbaijan, Bangladesh, Egypt, Iran, Iraq, Jordan, Kazakhstan, Kyrgyzstan, Lebanon, Libya, Pakistan, Sudan, Syria, Tajikistan, Turkmenistan, Uzbekistan, Yemen."],
	...
	Turkey: {
        ...
        note_for_children_below_18: ["Children below 18 years going without mother and father to Turkey need no objection letter notarized. 200/SR extra for this letter to be translated in Turkish language and need more days for processing the visa in this case."],
